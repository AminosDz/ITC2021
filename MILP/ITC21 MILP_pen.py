...
prevSolutionFolder = f'solutions/{prevExecName}/'
resultFolder = f'results/{execName}/'
...
model.setParam("TimeLimit", 86400) # 72000 172800 86400
...
init_sol_path = prevSolutionFolder +"br2_sol_"+f
